    ...
    <div className="profile-container">
      ...
      <div className="profile-content">
        ...
        <div className="menu-section">
          <button className="menu-item" onClick={() => {}}>
            <div className="menu-item-left">
              ...
              <div className="menu-text">
                ...
                <span className="menu-subtitle">Log in to use Favorites</span>
              </div>
            </div>
          ...
          <button className="menu-item" onClick={() => {}}>
            <div className="menu-item-left">
              ...
              <div className="menu-text">
                ...
                <span className="menu-subtitle">Log in to save useful Locations</span>
              </div>
            </div>
            <svg className="chevron-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M9 18l6-6-6-6"/>
          ...
          <button className="menu-item" onClick={() => navigate('/signin')}>
            <div className="menu-item-left">
              <div className="menu-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="menu-text">
                <span className="menu-title">Log in/Sign up</span>
              </div>
            </div>
            <svg className="chevron-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M9 18l6-6-6-6"/>
